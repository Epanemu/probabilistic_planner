...
def main():
    ...
    test_some_and_store("results/ff_replan_15", "dataset-assignment2/data/", "15", 1000, FFReplan)
    test_some_and_store("results/ff_replan_25", "dataset-assignment2/data/", "25", 1000, FFReplan)
    test_some_and_store("results/ff_replan_51", "dataset-assignment2/data/", "51", 100, FFReplan)
    test_some_and_store("results/ff_replan_101", "dataset-assignment2/data/", "101", 10, FFReplan)
